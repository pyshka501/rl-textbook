...
The following diagram contrasts the backup diagrams of dynamic programming and Monte Carlo.  In DP, a one-step backup averages over all possible next states using the model.  In MC, a single sampled trajectory is followed all the way to the terminal state.
